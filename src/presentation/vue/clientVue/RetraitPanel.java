...
public class RetraitPanel extends JPanel {
    ...
    private void initActions(){
        ...
        btn_add.addActionListener(e -> {
           ...
           if(actionResult.isSuccess()){
               JOptionPane.showMessageDialog(this,"Retrait termine","Succes",JOptionPane.INFORMATION_MESSAGE);
               txt_mnt.resetField("Montant");
               err_mnt.setText("");
               err_compte.setText("");
           }
    ...
    public RetraitPanel(IServiceClientGUI serviceClient, int top, int left, int bottom, int right){
